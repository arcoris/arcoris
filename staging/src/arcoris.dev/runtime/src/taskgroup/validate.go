...
const (
	...
	errNilValidationMessage = "taskgroup: nil validation message"

	// errNilGroupParent is the stable diagnostic text used when New
	// receives a nil parent context.
	errNilGroupParent = "taskgroup: nil group parent context"

	// errNilGroup is the stable diagnostic text used when a Group method is
	// called on a nil receiver.
	errNilGroup = "taskgroup: nil group"

	// errUninitializedGroup is the stable diagnostic text used when a Group
	// method is called on a zero-value Group.
	errUninitializedGroup = "taskgroup: uninitialized group"
