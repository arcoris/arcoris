...
//
// A Task is the smallest executable contract in package taskgroup. It represents one
...
//
// The Task contract is intentionally context-first. Package taskgroup does not define
...
//
// Package taskgroup does not recover panics raised by Task implementations. A panic is
