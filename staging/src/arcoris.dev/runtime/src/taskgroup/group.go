...
//
// A Group is created with New, starts named tasks with Go, exposes the
...
//
// New panics when parent is nil or when options produce invalid
// configuration. The returned Group is single-use and must not be copied after
// construction.
func New(parent context.Context, opts ...GroupOption) *Group {
