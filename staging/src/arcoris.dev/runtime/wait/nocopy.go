...
//
// Timer must not be copied after construction because copying it would duplicate
// the owner-controlled wrapper around the same underlying runtime timer. That
// obscures who owns Stop, StopAndDrain, Reset, Wait, and channel receives.
type noCopy struct{}
