...
// Schedule describes a reusable recipe for producing backoff delay sequences.
//
...
// not an error at the backoff layer. The owner decides whether exhaustion means
