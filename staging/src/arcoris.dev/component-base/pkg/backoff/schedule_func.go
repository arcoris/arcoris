...
const (
	...
	errNilScheduleFunc = "backoff: nil ScheduleFunc"
	...
	// loop.
	errScheduleFuncReturnedNilSequence = "backoff: ScheduleFunc returned nil Sequence"
)
...
// Example:
//
//	schedule := backoff.ScheduleFunc(func() backoff.Sequence {
//		return backoff.Fixed(time.Second).NewSequence()
//	})
...
// programming errors, not backoff exhaustion.
