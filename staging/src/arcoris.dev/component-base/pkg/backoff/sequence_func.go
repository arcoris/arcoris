...
const (
	...
	errNilSequenceFunc = "backoff: nil SequenceFunc"
	...
	errSequenceFuncReturnedNegativeDelay = "backoff: SequenceFunc returned negative delay"
)
...
// Example:
//
//	sequence := backoff.SequenceFunc(func() (time.Duration, bool) {
