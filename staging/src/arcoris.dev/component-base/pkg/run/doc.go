...
// internals.
//
// The package belongs to component-base because component runtimes often need to
// start a small set of related goroutines under one context, cancel siblings
// after a task failure, wait for deterministic completion, and return useful
// named task errors. It owns those task-group mechanics only. It does not own
...
//
// # Relationship to other component-base packages
//
