...
func TestPackageFixturesComposeWithHealthEvaluator(t *testing.T) {
	t.Parallel()

	evaluator := NewEvaluatorWithResults(t, health.TargetReady, HealthyResult("storage"))
	...
	AssertCheckOrder(t, report, "storage")
}
