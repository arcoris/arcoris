...
// references after Watch returns, and does not depend on package healthprobe.
//
// # Concurrency
//
...
// # Dependency policy
//
// Production code depends on the Go standard library, package health, package
// clock, and the standard gRPC health packages. It must not import
// arcoris.dev/apimachinery, package healthprobe, custom protobufs, logging,
// metrics, or tracing dependencies.
package healthgrpc
