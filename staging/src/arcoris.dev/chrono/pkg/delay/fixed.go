...
const (
	...
	// runtime loop code.
	errNegativeFixedDelay = "delay: negative fixed delay"
)
...
//
// Fixed panics when d is negative.
func Fixed(d time.Duration) Schedule {
	requireNonNegativeDuration(d, errNegativeFixedDelay)

	return fixedSchedule{delay: d}
}
...
// compose uniformly with wrappers such as Limit, Cap, jitter.Full,
// jitter.Positive, and jitter.Proportional.
