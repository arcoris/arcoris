...
const (
	...
	errNilRandomSource = "jitter: nil random source"
	...
	// boundary.
	errNilRandomSourceFunc = "jitter: nil RandomSourceFunc"
	...
	// boundary.
	errNilRandomFunc = "jitter: nil RandomFunc"
)
...
//	[0, 1<<63)
//
// The interface is named RandomGenerator instead of Random because Uniform owns
// random delay schedules while the generator is the lower-level draw primitive.
// Keeping those concepts distinct makes the schedule API and generator contract
// explicit.
//
...
// RandomSource creates random generators for jitter sequences.
//
