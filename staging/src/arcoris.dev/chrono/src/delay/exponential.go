...
const (
	...
	// immediate continuation should compose an explicit Immediate or Delays
	// schedule before an exponential schedule instead of using a zero initial
	// value.
	errNonPositiveExponentialInitialDelay = "delay: non-positive exponential initial delay"
	...
	// values cannot produce a stable runtime delay sequence.
	errInvalidExponentialMultiplier = "delay: invalid exponential multiplier"
)
...
//   - reconnect loops;
//   - controller loops that should slow down quickly after repeated failures;
...
// Production retry policies should usually compose Exponential with Cap and,
