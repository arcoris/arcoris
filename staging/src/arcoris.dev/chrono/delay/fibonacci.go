...
const (
	...
	// meaningful positive Fibonacci sequence. Callers that need an immediate
	// first step should compose an explicit Immediate or Delays schedule before a
	// Fibonacci schedule instead of using a zero base value.
	errNonPositiveFibonacciBaseDelay = "delay: non-positive fibonacci base delay"
)
...
//	...
//
// Fibonacci growth is faster than linear growth but usually slower than
// exponential growth. It is useful when fixed or linear intervals are too
