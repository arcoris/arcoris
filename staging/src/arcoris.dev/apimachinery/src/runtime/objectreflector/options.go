...
//
// Options intentionally contains no retry, backoff, queue, resync, cache, or
// filtering knobs. Those are higher-level runtime concerns.
type Options struct {
...
func DefaultOptions() Options {
	return Options{RequestProgress: true}
}
