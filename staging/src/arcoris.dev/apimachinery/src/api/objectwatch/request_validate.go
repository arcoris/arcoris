...
// Validate checks the structural request shape.
//
// Source capability checks are separate so callers can validate request shape
...
func (r Request) Validate() error {
	...
	if err := r.Start.Validate(); err != nil {
		return objectWatchError(
			...
			[]error{ErrInvalidRequest, ErrInvalidStart},
			err,
		)
	}
