...
func TestErrorReasonStringAndValidity(t *testing.T) {
	tests := []struct {
		...
		{name: "invalid list result", in: ErrorReasonInvalidListResult, text: "invalid_list_result", valid: true},
		{name: "invalid list item", in: ErrorReasonInvalidListItem, text: "invalid_list_item", valid: true},
