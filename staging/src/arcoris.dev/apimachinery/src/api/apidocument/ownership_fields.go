...
const (
	...
	// OwnershipFieldOwner is the ownership entry owner field.
	OwnershipFieldOwner FieldName = "owner"

	// OwnershipFieldFields is the ownership entry fields field.
	OwnershipFieldFields FieldName = "fields"
)
