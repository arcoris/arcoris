...
const (
	...
	// ErrorReasonInvalidValueKind reports an internally malformed non-zero value kind.
	ErrorReasonInvalidValueKind ErrorReason = "invalid_value_kind"

	// ErrorReasonInvalidResult reports a malformed comparison result.
	ErrorReasonInvalidResult ErrorReason = "invalid_result"

	// ErrorReasonInvalidResultBucket reports an invalid result bucket set.
	ErrorReasonInvalidResultBucket ErrorReason = "invalid_result_bucket"

	// ErrorReasonOverlappingResultPath reports a path assigned to multiple result buckets.
	ErrorReasonOverlappingResultPath ErrorReason = "overlapping_result_path"
)
