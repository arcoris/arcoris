...
func degradedSelector() fieldpath.Selector {
	return fieldpath.MustSelector(
		fieldpath.NewSelectorEntry(testFieldName("type"), fieldpath.StringLiteral("Degraded")),
	)
}

func progressingSelector() fieldpath.Selector {
	return fieldpath.MustSelector(
		fieldpath.NewSelectorEntry(testFieldName("type"), fieldpath.StringLiteral("Progressing")),
	)
}
