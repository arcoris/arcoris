...
// duplicateListMapEntryError reports repeated selector identity.
...
// listMapKeyFailure extracts the shared ListMap key diagnostic.
...
// compareListMapKeyErrorKind maps internal failure kinds to compare diagnostics.
