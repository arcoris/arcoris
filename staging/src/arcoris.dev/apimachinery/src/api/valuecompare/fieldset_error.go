...
// compareFieldSetError maps subtree extraction failures into compare diagnostics.
...
// compareFieldSetErrorKind maps public field-set errors to compare errors.
...
// compareFieldSetListKeyReason preserves missing-key classification.
