...
func (n Name) MarshalText() ([]byte, error) { return marshalText(n.String(), n.Validate) }
...
func (n Name) MarshalJSON() ([]byte, error) { return marshalJSONString(n.String(), n.Validate) }
