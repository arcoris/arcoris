...
func (k Key) MarshalJSON() ([]byte, error) {
	return marshalJSONString(k.String(), k.ValidateLexical)
}
...
func (k *Key) UnmarshalJSON(data []byte) error {
	...
	value, err := unmarshalJSONString("annotation.key", data)
	if err != nil {
		return err
	}
