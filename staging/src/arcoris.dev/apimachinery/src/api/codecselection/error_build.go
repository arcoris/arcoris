...
// errorAt creates a structured selection diagnostic without a nested cause.
...
// errorfAt creates a structured selection diagnostic with formatted detail text.
...
// wrapAt creates a structured selection diagnostic preserving a nested cause.
