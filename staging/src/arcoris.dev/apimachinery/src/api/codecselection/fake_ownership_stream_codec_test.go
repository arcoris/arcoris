...
func testOwnershipStreamRegistration(id string, mediaTypes ...codec.MediaType) codecregistry.Registration {
	return testRegistration(id, newOwnershipStreamCodec(codec.FormatJSON, mediaTypes...))
}
...
func newOwnershipStreamCodec(format codec.Format, mediaTypes ...codec.MediaType) *fakeOwnershipStreamCodec {
