...
func (f RefField) Required() RefField { f.field = f.field.withRequired(); return f }

// Optional marks the field key as optional.
func (f RefField) Optional() RefField { f.field = f.field.withOptional(); return f }
...
func (f RefField) Nullable() RefField { f.typ = f.typ.Nullable(); return f }

// Field returns a detached finalized field descriptor.
func (f RefField) Field() FieldDescriptor { return f.field.fieldWithType(f.typ.Type()) }
