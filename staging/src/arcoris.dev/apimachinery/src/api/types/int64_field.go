...
func (f Int64Field) Required() Int64Field { f.field = f.field.withRequired(); return f }

// Optional marks the field key as optional.
func (f Int64Field) Optional() Int64Field { f.field = f.field.withOptional(); return f }
...
func (f Int64Field) Nullable() Int64Field { f.typ = f.typ.Nullable(); return f }

// Min sets the inclusive int64 lower bound.
func (f Int64Field) Min(n int64) Int64Field { f.typ = f.typ.Min(n); return f }

// Max sets the inclusive int64 upper bound.
func (f Int64Field) Max(n int64) Int64Field { f.typ = f.typ.Max(n); return f }

// Range sets the inclusive int64 lower and upper bounds.
func (f Int64Field) Range(min, max int64) Int64Field { f.typ = f.typ.Range(min, max); return f }

// Enum stores accepted int64 literals for the field.
func (f Int64Field) Enum(values ...int64) Int64Field { f.typ = f.typ.Enum(values...); return f }

// Field returns a detached finalized field descriptor.
func (f Int64Field) Field() FieldDescriptor { return f.field.fieldWithType(f.typ.Type()) }
