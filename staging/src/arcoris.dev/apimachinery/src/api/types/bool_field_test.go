...
func TestBoolFieldWrapper(t *testing.T) {
	field := Field("value").Bool().Required().Nullable().Description("value").Field()
...
func TestBoolFieldExprMarker(t *testing.T) {
	Field("value").Bool().fieldExpr()
}

func TestBoolFieldOptionalPath(t *testing.T) {
	field := Field("value").Bool().Optional().Field()
