...
func TestNullFieldWrapper(t *testing.T) {
	field := Field("value").Null().Required().Description("value").Field()
...
func TestNullFieldExprMarker(t *testing.T) {
	Field("value").Null().fieldExpr()
}

func TestNullFieldOptionalPath(t *testing.T) {
	field := Field("value").Null().Optional().Field()
