...
func TestDateFieldWrapper(t *testing.T) {
	field := Field("value").Date().Required().Nullable().Description("value").Field()
...
func TestDateFieldExprMarker(t *testing.T) {
	Field("value").Date().fieldExpr()
}

func TestDateFieldOptionalPath(t *testing.T) {
	field := Field("value").Date().Optional().Field()
