...
// capability surface. It does not close the Reason vocabulary, does not register
// itself globally, and does not enforce Result validity. Reason validation
// remains syntax-level here; registry membership is an optional catalog concern
// for docs, config checks, and higher-level chain validation.
