...
var ErrInvalidComponentKindDescriptor = errors.New("admission: invalid component kind descriptor")
...
var ErrComponentKindAlreadyRegistered = errors.New("admission: component kind already registered")
