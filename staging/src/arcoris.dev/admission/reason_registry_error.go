...
var ErrInvalidReasonDescriptor = errors.New("admission: invalid reason descriptor")
...
var ErrReasonAlreadyRegistered = errors.New("admission: reason already registered")
